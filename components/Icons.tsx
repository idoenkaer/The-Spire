...
export const IconDice: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconShirt: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M20.38 3.4a2 2 0 0 0-1.2-1.28l-1.45-.31a2 2 0 0 1-1.24-.71l-.1-.13A2 2 0 0 0 14.8 0h-5.6a2 2 0 0 0-1.6.9l-.1.13a2 2 0 0 1-1.24.71l-1.45.31a2 2 0 0 0-1.2 1.28l-.63 3.12a2 2 0 0 0 1.25 2.27l.79.22a2 2 0 0 1 1.45 1.93v11.13a2 2 0 0 0 2 2h7.66a2 2 0 0 0 2-2V10.93a2 2 0 0 1 1.45-1.93l.79-.22a2 2 0 0 0 1.25-2.27Z" />
  </svg>
);
...
export const IconArch: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 21h18" />
    <path d="M5 21V7a8 8 0 0 1 14 0v14" />
    <path d="M10 21V11a2 2 0 0 1 4 0v10" />
  </svg>
);
